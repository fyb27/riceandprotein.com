export const meta = {
  name: 'foods-build-chunk2',
  description: 'Research + write 19 Malaysian/Bornean food calorie pages for the /foods/ pSEO database',
  phases: [
