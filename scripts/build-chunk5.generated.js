export const meta = {
  name: 'foods-build-chunk5',
  description: 'Research + write 11 Malaysian/Bornean food calorie pages for the /foods/ pSEO database',
  phases: [
