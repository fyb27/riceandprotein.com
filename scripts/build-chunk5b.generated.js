export const meta = {
  name: 'foods-build-chunk5-remaining',
  description: 'Research + write 7 Malaysian/Bornean food calorie pages for the /foods/ pSEO database',
  phases: [
